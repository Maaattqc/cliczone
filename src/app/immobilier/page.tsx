...
export const metadata: Metadata = {
  title: "Outils immobiliers | ClicZone",
  description:
    "Outils immobiliers pour le Québec : zones inondables, terrains contaminés, zonage et évaluations foncières. Données officielles.",
};

export default function ImmobilierPage() {
  const tools = getToolsByCategory("immobilier");
    ...
    <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <section className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl">
          Zones inondables, terrains contaminés, zonage et évaluations foncières au Québec.
        </p>
      </section>

      {/* Tool cards */}
      <section aria-label="Outils immobiliers" className="space-y-6">
