...
export const metadata: Metadata = {
  title: "Outils pour les familles | ClicZone",
  description:
    "Trouvez des garderies, CPE et places disponibles partout au Québec. Données officielles mises à jour régulièrement.",
};

export default function FamillesPage() {
  const tools = getToolsByCategory("familles");
    ...
    <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <section className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl">
          Garderies, CPE et places disponibles partout au Québec.
        </p>
      </section>

      {/* Tool cards */}
      <section aria-label="Outils familles" className="space-y-6">
